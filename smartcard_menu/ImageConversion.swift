...
class ImageConversionService {
    ...
    func convertJ2KToJPEG(inputURL: URL, outputURL: URL) async throws {
        ...
        guard FileManager.default.isReadableFile(atPath: inputURL.path) else {
            ...
            throw NSError(domain: "ImageConversionService", code: 1, userInfo: [NSLocalizedDescriptionKey: "Input file is not readable"])
        ...
        guard let decoder = opj_create_decompress(OPJ_CODEC_J2K) else {
            ...
            throw NSError(domain: "ImageConversionService", code: 2, userInfo: [NSLocalizedDescriptionKey: "Failed to create decoder"])
        ...
        guard opj_setup_decoder(decoder, &parameters) == OPJ_TRUE else {
            ...
            throw NSError(domain: "ImageConversionService", code: 3, userInfo: [NSLocalizedDescriptionKey: "Failed to setup decoder"])
        ...
        guard let inputStream = opj_stream_create_default_file_stream(inputPath, 1) else {
            ...
            throw NSError(domain: "ImageConversionService", code: 4, userInfo: [NSLocalizedDescriptionKey: "Failed to create input stream"])
        ...
        guard opj_read_header(inputStream, decoder, &image) == OPJ_TRUE else {
            ...
            throw NSError(domain: "ImageConversionService", code: 5, userInfo: [NSLocalizedDescriptionKey: "Failed to read header"])
        ...
        guard opj_decode(decoder, inputStream, image) == OPJ_TRUE,
            ...
            throw NSError(domain: "ImageConversionService", code: 6, userInfo: [NSLocalizedDescriptionKey: "Failed to decode image"])
        ...
        guard let context = CGContext(data: nil,
            ...
            throw NSError(domain: "ImageConversionService", code: 7, userInfo: [NSLocalizedDescriptionKey: "Failed to create CGContext"])
        ...
        guard let destination = CGImageDestinationCreateWithURL(outputURL as CFURL, jpegType, 1, nil) else {
            ...
            throw NSError(domain: "ImageConversionService", code: 10, userInfo: [NSLocalizedDescriptionKey: "Error: Failed to create image destination"])
        ...
        guard CGImageDestinationFinalize(destination) else {
            ...
            throw NSError(domain: "ImageConversionService", code: 11, userInfo: [NSLocalizedDescriptionKey: "Error: Failed to write JPEG file"])
        }
